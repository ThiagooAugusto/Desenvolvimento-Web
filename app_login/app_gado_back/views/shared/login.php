                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-7">
                        <div class="card-body">
                            ...
                            <p class="login-card-description">Acesse a sua conta</p>
                            <form action="valida_login.php" method="post">
                                ...
                                <button class="btn btn-info btn-block btn-lg" type="submit">Entrar</button>
                            </form>
                            <a href="cadastro.php" class="forgot-password-link">Não é cadastrado? Cadastre aqui</a>
                        </div>
                    </div>
                </div>
            </div>
